...
namespace Samples
{
    public class EWrapperImpl : EWrapper 
    {
        ...
        public virtual void realtimeBar(int reqId, long time, double open, double high, double low, double close, long volume, double WAP, int count)
        {
            ...
            var now = epoch.AddSeconds(time);
            now = now.AddHours(-4);

            if (now.Minute <= 2)
            {
                var s = "RealTimeBars. " + reqId + " - Time: " + now.ToString() + ", Open: " + open + ", High: " + high + ", Low: " + low + ", Close: " + close + ", Volume: " + volume + ", Count: " + count + ", WAP: " + WAP;
                log.Debug(s);
            }
        }
        ...
        public void InitLog()
        {
            ...
            fileAppender.File = "C:\\Users\\Alexandre\\Desktop\\Forex\\LogsCSharp\\" + date + "\\!main.txt";
        ...
        public void InitContracts()
        {
            ...
            foreach (var symbol in symbols)
            {
                ...
                contract.Currency = symbol.Substring(3, 6);
